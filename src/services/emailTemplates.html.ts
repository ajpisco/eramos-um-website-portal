...
// This file contains pure HTML templates with variable placeholders

// Full admission application email template (based on public/templates/application_email.html)
export const ADMISSION_APPLICATION_FORM = `
<!DOCTYPE html>
<html lang="pt">
<head>
  <meta charset="UTF-8" />
